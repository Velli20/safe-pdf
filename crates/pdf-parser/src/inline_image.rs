...
impl PdfParser<'_> {
    ...
    pub fn parse_inline_image(
        ...
        let data = self.read_inline_image_data_until_end()?;
    ...
    fn read_inline_image_data_until_end(&mut self) -> Result<Vec<u8>, ParserError> {
    ...
    fn find_inline_image_data_end(&mut self) -> Result<usize, ParserError> {
